        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
          <div class="md:col-span-1 flex justify-between">
            <div class="px-4 sm:px-0">
              ...
              <p class="mt-5 text-sm text-gray-600 dark:text-gray-500">
                <span class="font-semibold text-black">Читаем ВНИМАТЕЛЬНО:</span> <br>
                Ваши пароли шифруются и в базе хранятся в ЗАШИФРОВАННОМ виде. Если вы его забудете - я не смогу его вам напомнить! <br>
                Если все же забыли пароль или в этом разделе сделали пароль в виде белиберды и забыли через минуту - напишите мне, скину вручную.
              </p>
            </div>
          </div>
          <div class="md:mt-0 md:col-span-2">
