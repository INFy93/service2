<template>
  <div>
    <div class="mb-2 mt-2 flex flex-row items-center">
      <div>
        <a class="update-button flex flex-row space-x-3">
          <button
          ...
          <a
            class="flex items-center justify-center cursor-pointer bg-blue-500 hover:bg-blue-700 dark:bg-blue-900 dark:hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg"
            href="/mac"
          >
            <span class="hidden normal bg-yellow-500 bg-blue-500"></span>
      ...
      <div class="flex justify-end items-center ml-auto">
        <div
          class="wrapper w-40 bg-gray-700 rounded-lg cursor-pointer"
          :class="{ 'bg-gray-500': showOnlyOpen }"
          @click="onlyOpen"
        >
          <div
            class="flex text-white rounded-lg py-2 px-2 space-x-3 justify-left items-center"
          >
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-7 w-7 text-xl"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                stroke-width="2"
